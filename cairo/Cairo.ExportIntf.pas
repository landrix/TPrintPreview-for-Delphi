...
function CairoExport: ICairoExporter; stdcall;
{$ENDIF}
...
begin
  ...
  begin
    ...
    begin
      @GCall := GetProcAddress(GDllHandle, 'CairoExport');
      if @GCall <> nil then
